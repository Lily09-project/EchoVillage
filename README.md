...
4. 回到村落手札查看聲望、成就、編年與已發生的後果；按 `L` 回顧當日的重要回音。
...
村落手札提供聲望、稱號、進度條、成就里程碑與文字化完成狀態，開啟時會可靠暫停模擬。按 `L` 可切換到「今日回音」，查看當日居民、世界、任務、經濟與地點事件的分類摘要。
